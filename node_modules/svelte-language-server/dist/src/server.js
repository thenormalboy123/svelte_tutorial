...
function startServer(options) {
    ...
    connection.onInitialize((evt) => {
        ...
        const workspacePath = utils_1.urlToPath(evt.rootUri || '') || '';
        logger_1.Logger.log('Initialize language server at ', workspacePath);
        if (!workspacePath) {
            logger_1.Logger.error('No workspace path set');
        }
        pluginHost.initialize(!!((_a = evt.initializationOptions) === null || _a === void 0 ? void 0 : _a.dontFilterIncompleteCompletions));
        pluginHost.updateConfig((_b = evt.initializationOptions) === null || _b === void 0 ? void 0 : _b.config);
        pluginHost.register((sveltePlugin = new plugins_1.SveltePlugin(configManager, ((_c = evt.initializationOptions) === null || _c === void 0 ? void 0 : _c.prettierConfig) || {})));
        ...
        pluginHost.register(new plugins_1.TypeScriptPlugin(docManager, configManager, workspacePath));
        const clientSupportApplyEditCommand = !!((_d = evt.capabilities.workspace) === null || _d === void 0 ? void 0 : _d.applyEdit);
        return {
            capabilities: {
                textDocumentSync: {
                    openClose: true,
                ...
                codeActionProvider: ((_f = (_e = evt.capabilities.textDocument) === null || _e === void 0 ? void 0 : _e.codeAction) === null || _f === void 0 ? void 0 : _f.codeActionLiteralSupport) ? {
                    codeActionKinds: [
                ...
                executeCommandProvider: clientSupportApplyEditCommand
                    ...
                    : undefined,
                renameProvider: ((_h = (_g = evt.capabilities.textDocument) === null || _g === void 0 ? void 0 : _g.rename) === null || _h === void 0 ? void 0 : _h.prepareSupport) ? { prepareProvider: true }
                    : true,
            },
        };
    });
