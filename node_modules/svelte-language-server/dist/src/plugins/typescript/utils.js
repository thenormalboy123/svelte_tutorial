...
function findTsConfigPath(fileName, rootPath) {
...
function isSubPath(path, possibleSubPath) {
    const relativePath = path_1.relative(path, possibleSubPath);
    return !!relativePath && !relativePath.startsWith('..') && !path_1.isAbsolute(relativePath);
}
