...
function preprocessSvelteFile(document, options) {
    ...
    try {
        ...
        if (tsxMap) {
            ...
            const tsCheck = utils_2.getTsCheckComment((_f = document.scriptInfo) === null || _f === void 0 ? void 0 : _f.content);
            if (tsCheck) {
                text = tsCheck + text;
                nrPrependedLines = 1;
            }
        ...
        const start = {
            line: (_h = ((_g = e.start) === null || _g === void 0 ? void 0 : _g.line) - 1) !== null && _h !== void 0 ? _h : 0,
            character: (_k = (_j = e.start) === null || _j === void 0 ? void 0 : _j.column) !== null && _k !== void 0 ? _k : 0,
        };
...
class SvelteDocumentSnapshot {
    ...
    async getMapper(uri) {
        ...
        if (!this.tsxMap) {
            return new documents_1.FragmentMapper(this.parent.getText(), this.parent.scriptInfo, uri);
        }
