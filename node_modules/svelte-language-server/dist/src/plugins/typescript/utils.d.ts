...
export declare function findTsConfigPath(fileName: string, rootPath: string): string;
export declare function isSubPath(path: string, possibleSubPath: string): boolean;
